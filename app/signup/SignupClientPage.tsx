    ...
    <main className="relative min-h-screen overflow-x-clip bg-neutral-950 text-white">
      ...
      <section className="mx-auto grid w-[92%] max-w-lg place-items-center pt-16">
        <div className="relative w-full overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
          <div className="absolute -right-8 -top-8 size-56 -rotate-6 bg-gradient-to-br from-fuchsia-400/15 to-emerald-500/15 blur-2xl" />
          <h1 className="text-2xl font-bold">Create your account</h1>
          <p className="mb-4 mt-1 text-sm text-white/70">Join Falcon Metrics.</p>
  ...
  return (
    <label className="grid gap-1 text-sm">
      ...
      <input
        name={name}
        type={type}
        className="w-full rounded-lg border border-white/15 bg-black/30 px-3 py-2 text-sm text-white outline-none transition focus:border-emerald-400/50 focus:shadow-[0_0_0_4px_rgba(16,185,129,0.15)]"
